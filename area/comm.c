...
*/
	...
	else
	{
	    ...
	    write_to_buffer( d, buf, 0 );
            ...
            write_to_buffer( d, "do not abuse CaPiToL lEtTeRs, do not have an offensive\n\r",0);
            write_to_buffer( d, "or racist name, and try to keep it somewhat RP.\n\r",0);
...
/*	act( "$n has entered RotK.", ch, NULL, NULL, TO_ROOM );
	...
	wiznet("$N has entered RotK.",ch,NULL,
        ...
        {
        do_announce( ch, "has entered RotK." );
        do_look( ch, "auto" );
        wiznet("$N has entered RotK.",ch,NULL,
                WIZ_LOGINS,WIZ_SITES,get_trust(ch));
        }
