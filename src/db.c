...
sh_int			gsn_critical_damage;
sh_int          gsn_piercing;
sh_int			gsn_kick;
sh_int          gsn_thunderkick;
sh_int			gsn_parry;
sh_int			gsn_rescue;
...
sh_int			gsn_impale;
sh_int			gsn_knee;
sh_int			gsn_holy_fury;
sh_int			gsn_bind;
sh_int			gsn_strike;
sh_int          gsn_spy;
sh_int			gsn_deathblow;
sh_int			gsn_awareness;
sh_int			gsn_blind_rage;
sh_int			gsn_whirlwind;
sh_int          gsn_multishot;
sh_int			gsn_rub;
...
break;
	...
	break;
	case ITEM_TOKEN:
            pObjIndex->value[0] = pObjIndex->value[0];
            break;
    }
