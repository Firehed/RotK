...
void do_curse(CHAR_DATA *ch, char *argument)
{
	...
	send_to_char("  align:     Firehed's favor        20 gold\n\r",ch);
	send_to_char("  sanctuary: Firehed's protection   35 gold\n\r",ch);
	send_to_char("  speed:     Firehed's speed        5 gold\n\r",ch);
    ...
    {
	act("$N says '{aFirehed does not protect the pure of heart!{x'",
	    ch,NULL,mob,TO_CHAR);
	return;
    }
	...
	send_to_char("You feel Wardrof's anger toward your actions!\n\r",ch);
	return;
     }
