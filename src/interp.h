...
DECLARE_DO_FUN( do_autotitle	); // Eric 12-17-01
...
DECLARE_DO_FUN( do_blind_rage	);
DECLARE_DO_FUN( do_ipcheck	    );
DECLARE_DO_FUN( do_pretitle     );
DECLARE_DO_FUN( do_rub		    );
DECLARE_DO_FUN( do_invisin	    );
DECLARE_DO_FUN( do_invisout	    );
DECLARE_DO_FUN( do_hedit	    );
DECLARE_DO_FUN( do_spy          );
DECLARE_DO_FUN( do_qp           );
DECLARE_DO_FUN( do_qi           );
DECLARE_DO_FUN( do_qt           );
DECLARE_DO_FUN( do_qr           );
DECLARE_DO_FUN( do_qc           );
DECLARE_DO_FUN( do_ql           );
DECLARE_DO_FUN( do_qb           );
DECLARE_DO_FUN( do_qq           );
DECLARE_DO_FUN( do_knee         );
DECLARE_DO_FUN( do_bind         );
DECLARE_DO_FUN( do_strike       );
DECLARE_DO_FUN( do_holy_fury    );
...
DECLARE_DO_FUN( do_quiet_nuke   );
DECLARE_DO_FUN( do_nogsocial	);
DECLARE_DO_FUN( do_rpnote   	);
DECLARE_DO_FUN( do_damage   	);
DECLARE_DO_FUN( do_slist        );
DECLARE_DO_FUN( do_pklist   	);
DECLARE_DO_FUN( do_rp           );
DECLARE_DO_FUN( do_death_bite   );
DECLARE_DO_FUN( do_paets        );
DECLARE_DO_FUN( do_htrecall     );
DECLARE_DO_FUN( do_refill       );
DECLARE_DO_FUN( do_multishot    );
DECLARE_DO_FUN( do_locker       );
DECLARE_DO_FUN( do_cleadgossip  );
DECLARE_DO_FUN( do_whirlwind    );
DECLARE_DO_FUN( do_thunderkick  );
DECLARE_DO_FUN( do_doubleexp    );
DECLARE_DO_FUN( do_nopk         );
DECLARE_DO_FUN( do_nocorpse     );
DECLARE_DO_FUN( do_nosafe       );
DECLARE_DO_FUN( do_globals      );
DECLARE_DO_FUN( do_bloodbath    );
DECLARE_DO_FUN( do_godsight     );
