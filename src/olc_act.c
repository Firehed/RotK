...
REDIT( redit_oreset )
{
	...
	if ( to_mob->pIndexData->pShop )	/* Shop-keeper? */
	{
	    ...
	    case ITEM_QUIVER:	olevel = number_range(  5, 15 );	break;
...
/* ARMOR for ROM: */
	    ...
	    switch ( value_num )
	    {
		    ...
		    return FALSE;
	        case 0:
		    send_to_char( "CURRENT ARROWS SET.\n\r\n\r", ch );
		    pObj->value[0] = atoi( argument );
		    break;
	        case 1:
		    send_to_char( "DICE BONUS 1 SET.\n\r\n\r", ch );
		    pObj->value[1] = atoi( argument );
		    break;
	        case 2:
		    send_to_char( "DICE BONUS 2 SET.\n\r\n\r", ch );
		    pObj->value[2] = atoi( argument );
		    break;
	        case 3:
		    send_to_char( "MAX ARROWS SET.\n\r\n\r", ch );
...
OEDIT( oedit_addapply )
{
	...
	send_to_char( "(Example: addapply affects none 0 pass_door)\n\r", ch );
	return FALSE;
    }
...
MEDIT( medit_damtype )
{
	...
	send_to_char( "For a list of damage messages, type '? weapon'.\n\r", ch );
	return FALSE;
    }
...
MEDIT( medit_shop )
{
	...
	if ( !pMob->pShop )
	{
	    send_to_char( "MEdit:  You need to create a shop first! (shop assign).\n\r", ch );
	    return FALSE;
	}
...
MEDIT( medit_ac )
{
    ...
    send_to_char( "Syntax:  ac [defense]\n\r"
		  "help MOB_AC  gives a list of reasonable defense-values.\n\r", ch );
    return FALSE;
}
