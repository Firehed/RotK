...
const struct flag_type room_flags[] =
{
    ...
    {   "onehp",        ROOM_ONEHIT,    TRUE    },
    {   "no_quaff",     ROOM_NO_QUAFF,  TRUE    },
    {	NULL,			0,			0	}
};
...
const struct flag_type wear_flags[] =
{
    ...
    {	"ankles",		ITEM_WEAR_ANKLES,	TRUE	},
    {	"face",			ITEM_WEAR_FACE,		TRUE	},
    {	"smoked",		ITEM_WEAR_SMOKED,	TRUE	},
...
const struct flag_type wear_loc_strings[] =
{
    ...
    {	"on the left ear",	WEAR_EAR_R,	TRUE	},
    {	"with pride (1)",	WEAR_PRIDE_1,	TRUE	},
    {	"with pride (2)",	WEAR_PRIDE_2,	TRUE	},
    {	"around the ankles",	WEAR_ANKLES,	TRUE	},
    {	"on the face",		WEAR_FACE,	TRUE	},
    {	"in the mouth",		WEAR_SMOKED,	TRUE	},
    {	NULL,			0	      , 0	}
};
...
const struct flag_type wear_loc_flags[] =
{
    ...
    {	"pride1",	WEAR_PRIDE_1,	TRUE	},
    {	"pride2",	WEAR_PRIDE_2,	TRUE	},
    {	"ankles",	WEAR_ANKLES,	TRUE	},
    {	"face",		WEAR_FACE,	TRUE	},
    {	"smoked",	WEAR_SMOKED,	TRUE	},
    {	NULL,		0,		0	}
};
...
{
/*      { "name",      recallg, recallb, "align" }, */
        { "Midgaard",  3001,  3365,  "neutral" },
        { "Talagrath", 17058, 17058, "good or neutral" },
        { "Poway",     21415, 21415, "good" },
};
