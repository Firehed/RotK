...
void spell_acidshield(int sn, int level, CHAR_DATA *ch, void *vo, int target)
{
    ...
    {
	if (victim == ch)
	    send_to_char("You are already surrounded by an {@acidic{x shield.\r\n", ch);
	else
	    act("$N is already surrounded by an {@acidic{x shield.",ch,NULL,victim,TO_CHAR);
	return;
    }
    ...
    affect_to_char(victim, &af);
    send_to_char("You are surrounded by an {@acidic{x shield.\n\r", victim);
    act("$n is surrounded by an {@acidic{x shield.",victim, NULL,NULL,TO_ROOM);
    return;
...
void spell_watershield(int sn, int level, CHAR_DATA *ch, void *vo, int target)
{
    ...
    {
	if (victim == ch)
	    send_to_char("You are already surrounded by a {4water{0 bubble.\r\n", ch);
	else
	    act("$N is already surrounded by a {4water{0 bubble.",ch,NULL,victim,TO_CHAR);
	return;
    }
    ...
    affect_to_char(victim, &af);
    send_to_char("You are surrounded by a {4water {0bubble.\n\r", victim);
    act("$n is surrounded by a {4water {0bubble.",victim, NULL,NULL,TO_ROOM);
    return;
...
void spell_holyshield(int sn, int level, CHAR_DATA *ch, void *vo, int target)
{
    ...
    {
	if (victim == ch)
	    send_to_char("You are already surrounded by a {&holy{x shield.\r\n", ch);
	else
	    act("$N is already surrounded by a {&holy{x shield.",ch,NULL,victim,TO_CHAR);
	return;
    }
    ...
    af.location  = APPLY_NONE;
    af.modifier  = 0;
    af.bitvector = SHD_HOLY;

    affect_to_char(victim, &af);
    send_to_char("You are surrounded by a {&holy{x shield.\n\r", victim);
    act("$n is surrounded by a {&holy{x shield.",victim, NULL,NULL,TO_ROOM);
    return;

}

void spell_glassshield(int sn, int level, CHAR_DATA *ch, void *vo, int target)
{
    ...
    {
	if (victim == ch)
	    send_to_char("You are already surrounded by a {*glass{x shield.\r\n", ch);
	else
	    act("$N is already surrounded by a {*glass{x shield.",ch,NULL,victim,TO_CHAR);
	return;
    }
    ...
    af.location  = APPLY_NONE;
    af.modifier  = 0;
    af.bitvector = SHD_GLASS;

    affect_to_char(victim, &af);
    send_to_char("You are surrounded by a {*glass{x shield.\n\r", victim);
    act("$n is surrounded by a {*glass{x shield.",victim, NULL,NULL,TO_ROOM);
    return;
...
void spell_quest_pill( int sn, int level, CHAR_DATA *ch, void *vo,int target )
{
    ...
    victim->qps+=10;
    send_to_char( "{YYou've gained {^10 {RQuest Points{Y!{x\n\r", victim );
    if ( ch != victim )
	send_to_char( "Ok.\n\r", ch );
    return;
}
