...
DECLARE_SPELL_FUN(  spell_quatre        );
DECLARE_SPELL_FUN(  spell_cure		);
DECLARE_SPELL_FUN(  spell_cura		);
DECLARE_SPELL_FUN(  spell_curaga	);
DECLARE_SPELL_FUN(  spell_fulllife	);
DECLARE_SPELL_FUN(  spell_regen		);
DECLARE_SPELL_FUN(  spell_fire_sword    );
DECLARE_SPELL_FUN(  spell_ultima	);
DECLARE_SPELL_FUN(  spell_make_bag	);
DECLARE_SPELL_FUN(  spell_random_ring);
DECLARE_SPELL_FUN(  spell_holyfire);
DECLARE_SPELL_FUN(  spell_shadowfire);
DECLARE_SPELL_FUN(  spell_energy_bed    );
