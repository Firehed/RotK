...
#define PULSE_AUTO_SAVE    (900 * PULSE_PER_SECOND)
...
struct	descriptor_data
{
    ...
    bool		fcommand;
    bool                ansi;
    bool                colorized; /* Color Greetings */
...
struct	class_type
{
    ...
    bool    metal;          /* can they wear metal items? */
};
...
#define OFF_FEED		(V)
#define OFF_DEATHBLOW		(W)
#define OFF_IMPALE		(X)
#define OFF_BLIND_RAGE		(Y)
#define OFF_KNEE           (Z)
#define OFF_STRIKE         (aa)
#define OFF_MULTISHOT       (bb)
...
#define SHD_FIRE		(D)
#define SHD_SHOCK		(E)
#define SHD_IMPROVED_SANCTUARY  (F)
#define SHD_CAMO                (G)
...
#define OBJ_VNUM_SCHOOL_BOW        3799
...
#define OBJ_VNUM_SURVIVAL_A	  20000
#define OBJ_VNUM_SURVIVAL_B	  20001
#define OBJ_VNUM_SURVIVAL_C	  20002
#define OBJ_VNUM_SURVIVAL_D	  20003
#define OBJ_VNUM_SURVIVAL_E	  20004
#define OBJ_VNUM_SURVIVAL_F	  20005
#define OBJ_VNUM_SURVIVAL_G	  20006
#define OBJ_VNUM_SURVIVAL_H	  20007
#define OBJ_VNUM_SURVIVAL_I	  20008
#define OBJ_VNUM_SURVIVAL_J	  20009
#define OBJ_VNUM_SURVIVAL_K	  20010
#define OBJ_VNUM_SURVIVAL_L	  20011
#define OBJ_VNUM_SURVIVAL_M	  20012
#define OBJ_VNUM_SURVIVAL_N	  20013
#define OBJ_VNUM_SURVIVAL_O	  20014
#define OBJ_VNUM_SURVIVAL_P	  20015
#define OBJ_VNUM_SURVIVAL_Q	  20016
#define OBJ_VNUM_SURVIVAL_R	  20017
#define OBJ_VNUM_SURVIVAL_S	  20018
#define OBJ_VNUM_SURVIVAL_T	  20019
#define OBJ_VNUM_SURVIVAL_U	  20020
#define OBJ_VNUM_SURVIVAL_V	  20021
#define OBJ_VNUM_SURVIVAL_W	  20022
#define OBJ_VNUM_SURVIVAL_X	  20023
#define OBJ_VNUM_SURVIVAL_Y	  20024
#define OBJ_VNUM_SURVIVAL_Z	  20025
#define OBJ_VNUM_SURVIVAL_AA      20027
#define OBJ_VNUM_SURVIVAL_BB      20028
#define OBJ_VNUM_PROTOPLASM	  20050

#define OBJ_VNUM_RANDOM_RING    3723
#define OBJ_VNUM_RANDOM_AMULET  3724
#define OBJ_VNUM_RANDOM_GLOVES  3725
#define OBJ_VNUM_RANDOM_SLEEVES 3726
#define OBJ_VNUM_RANDOM_ARMOR   3727
#define OBJ_VNUM_RANDOM_BOOTS   3728
#define OBJ_VNUM_RANDOM_SWORD   3729
#define OBJ_VNUM_RANDOM_HELMET  3730
#define OBJ_VNUM_RANDOM_MASK    3731
#define OBJ_VNUM_RANDOM_PANTS   3732
#define OBJ_VNUM_RANDOM_SHIELD  3733
#define OBJ_VNUM_RANDOM_BRACER  3734
#define OBJ_VNUM_RANDOM_ANKLET  3735
#define OBJ_VNUM_RANDOM_DAGGER  3736
#define OBJ_VNUM_RANDOM_EARRING 3737
#define OBJ_VNUM_RANDOM_ORB     3738
#define OBJ_VNUM_RANDOM_BODY    3739
#define OBJ_VNUM_RANDOM_WAIST   3740
#define OBJ_VNUM_RANDOM_FLOAT   3741
#define OBJ_VNUM_RANDOM_LIGHT   3742
#define OBJ_VNUM_RANDOM_STAFF   3743
#define OBJ_VNUM_RANDOM_MACE    3744
#define OBJ_VNUM_RANDOM_AXE     3745
#define OBJ_VNUM_RANDOM_FLAIL   3746
#define OBJ_VNUM_RANDOM_WHIP    3747
#define OBJ_VNUM_RANDOM_POLEARM 3748
#define OBJ_VNUM_RANDOM_BOW     3749
#define OBJ_VNUM_RANDOM_QUIVER  3750


#define OBJ_VNUM_FIRE_SWORD     19
...
#define ITEM_WEAR_PRIDE		(T)
#define ITEM_WEAR_ANKLES	(U)
#define ITEM_WEAR_SMOKED	(V)
...
#define ROOM_VNUM_BANK		   3383
#define ROOM_VNUM_QUEST		   3382
 ...
 */
#define ROOM_DARK		(A)
#define ROOM_NO_QUAFF   (B)
#define ROOM_NO_MOB		(C)
#define ROOM_INDOORS		(D)
#define ROOM_NOQUEST		(E) /* Firehed 12-12-01 */
...
#define WEAR_PRIDE_1		     23
#define WEAR_PRIDE_2		     24
#define WEAR_ANKLES		     25
#define WEAR_SMOKED		     26
#define MAX_WEAR		     27
...
#define PLR_CONSENT		(O) /* Firehed 11-26-01 */
#define PLR_CANLOOT		(P)
#define PLR_NOSUMMON		(Q)
#define PLR_NOFOLLOW		(R)
#define PLR_AUTOTITLE		(S) /* Firehed 12-17-01 */
/* 2 bits reserved, S-T */
#define PLR_SCORE               (T) /* For COMM_SHOW_AFFECTS, possible future uses elsewhere */
/* penalty flags */
#define PLR_PERMIT		(U)
#define PLR_LOG			(W)
#define PLR_DENY		(X)
...
#define COMM2_RP                (A)
#define COMM2_PAETS             (B) /* People Against the Ethical Treatment of SPEDs */
/* WIZnet flags */
#define WIZ_ON			(A)
#define WIZ_TICKS		(B)
#define WIZ_LOGINS		(C)
...
struct	char_data
{
    sh_int              hometown; /* Hometown code - Firehed 7-26-02 */
    ...
    sh_int              questobj;
    sh_int              questmob;
    int			corner_timer; /* Firehed 12-30-01 */
    CHAR_DATA *		next;
...
struct	pc_data
{
    char *      godsight;  /* Godsight code... semi-experimental */
    long                comm2;
    int			pkkills;
    int                 pktotal;
    int			pkdeaths;
...
extern	sh_int	gsn_critical_damage;
extern  sh_int  gsn_piercing;
extern	sh_int	gsn_thunderkick;
...
#define IS_FIRST_TIER(ch)       ((ch)->tier = 0)
#define IS_SECOND_TIER(ch)      ((ch)->tier = 1)
#define IS_THIRD_TIER(ch)       ((ch)->tier = 2)
...
#define IS_GODSIGHT(ch, victim)	( strstr( victim->pcdata->godsight, ch->name )	  \
				|| strstr( victim->pcdata->godsight, "All" ) )
...
#define RPNOTE_FILE     "rpnotes.not" /*RPNOTES */
...
char    *logincolor     args( ( char type ) ); /* For color logins, I hope :) */
...
#define	LOCKER_VNUM     3333
#define	LOCKER_ROOM		3395	//Set this to your temple pit or whatever
...
extern const struct flag_type   abs_flags[];
...
extern  const   struct  hometown_type   hometown_table[]; /* Hometowns */
